jQuery(document).ready(function () {
    ...
    if (showModal === "1") {
        ...
        if (jQuery("#Titulos").length > 0) {
            // Abre el modal
            Mostrar(Nombre, Carnet, historial, direccion);
            jQuery("#Titulos").modal("show");
        } else {
        ...
        for (var i = 0; i < historiales.length; i++) {
            ...
            (function (indice) {
                boton.onclick = function () {
                    borrarArchivo(historiales[indice].Fotocopia_tit);
                };
            })(i);
            ...
            enlace.href = direccion + "/" + historiales[i].Fotocopia_tit; // Aquí debes especificar la URL deseada
            ...
            if (permisoBorrarTitulo == 1) {
                var celda5 = fila.insertCell(4);
            }

            // Llenar las celdas con los datos
            celda1.innerHTML = historiales[i].Tipo_tit;
            celda2.innerHTML = historiales[i].Descripcion_tit;
            celda3.innerHTML = historiales[i].Fecha_tit;
